...
import zerotwobot.modules.sql.nsfw_sql as sql
...
CLASSIC_HANDLER = CommandHandler("vhentai", classic, run_async=True)
KUNI_HANDLER = CommandHandler("kuni", kuni, run_async=True)
WAIFU_HANDLER = CommandHandler("gf", waifu, run_async=True)
LEWD_HANDLER = CommandHandler("lewd", lewd, run_async=True)
